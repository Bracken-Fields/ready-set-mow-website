...
const Icon = ({ name, size = 22, stroke = 2, className = "", style = {} }) => {
  ...
  switch (name) {
    ...
    case "shield": return <svg {...common}><path d="M12 2 4 7v6c0 5 3.5 8.5 8 9 4.5-.5 8-4 8-9V7l-8-5z"/></svg>;
    ...
    case "leaf": return <svg {...common}><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96c1.4 9.3-2.6 14.4-7.4 17.2"/><path d="M2 21c0-3 1.85-5.36 5.08-6"/></svg>;
    ...
    case "sparkles": return <svg {...common}><path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5z"/><path d="M19 14l.8 2.2L22 17l-2.2.8L19 20l-.8-2.2L16 17l2.2-.8z"/></svg>;
    default: return null;
  }
};
window.RSMIcon = Icon;
